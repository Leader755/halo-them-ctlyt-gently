...
<header class="header_area">
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container box_1620">
                ...
                <a class="navbar-brand logo_h" href="${context!}"><img src="${options.blog_logo!}" alt="">${options.blog_title!}</a>
    ...
    <div class="logo_part">
        <div class="container">
            <a class="logo ctlyt-logo" href="${context!}"><img src="${options.blog_logo!}"  alt=""> ${options.blog_title!}</a>
        </div>
    </div>
</header>
